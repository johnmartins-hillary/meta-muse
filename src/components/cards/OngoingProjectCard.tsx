...
const Card: React.FC<CardProps> = ({ title, description, progress, update, activities }) => {
  return (
    ...
    <div className='flex gap-2 h-[50%]'>
        {/* Description Section */}
        <div className="flex flex-col bg-[#351A1A] text-white p-4 flex-grow w-[50%] rounded-md items-center justify-center">
        <h3 className="text-sm font-semibold text-white ">Description</h3>
        <p className="text-gray-300 text-xs mt-1">{description}</p>
        </div>
          
        {/* Artist Section */}
        <div className="flex flex-col bg-[#171717] text-white p-4 flex-grow w-[50%] rounded-md items-center justify-center">
    ...
    <div className='flex gap-2 h-[50%]'>
      {/* Progress Section */}
      <div className="bg-[#171717] text-white p-2 flex  flex-col  text-xs w-[50%] rounded-md items-center justify-center">
        <span className="text-green-400 font-semibold">{progress}</span>
        <span className="text-gray-300">{update}</span>
      </div>

      {/* Recent Activities Section */}
      <div className="flex flex-col bg-[#161C29] text-gray-300 p-3 w-[50%] rounded-md items-center justify-center">
