  ...
  component: () => {
    ...
    const handleMouseDown = () => {
      ...
      if (selectedTool === 'brush') {
        setLines([...lines, { points: [pos.x, pos.y], color: brushColor, width: brushSize }]);
      } else if (selectedTool === 'rectangle') {
        setShapes([...shapes, { type: 'rectangle', x: pos.x, y: pos.y, color: brushColor, width: 100, height: 100 }]);
      } else if (selectedTool === 'circle') {
        setShapes([...shapes, { type: 'circle', x: pos.x, y: pos.y, color: brushColor, radius: 50 }]);
      } else if (selectedTool === 'text' && text) {
        setTexts([...texts, { text, x: pos.x, y: pos.y, color: brushColor }]);
        setText('');
      }
    };
